insert into comment(movie_id,user_id,content,addtime) values(25,1,"好看",now());
insert into comment(movie_id,user_id,content,addtime) values(25,2,"不错",now());
insert into comment(movie_id,user_id,content,addtime) values(25,3,"经典",now());
insert into comment(movie_id,user_id,content,addtime) values(26,4,"给力",now());
insert into comment(movie_id,user_id,content,addtime) values(26,5,"难看",now());
insert into comment(movie_id,user_id,content,addtime) values(26,6,"无聊",now());
insert into comment(movie_id,user_id,content,addtime) values(26,7,"乏味",now());
insert into comment(movie_id,user_id,content,addtime) values(27,8,"无感",now());
